...
#include "../../vendor/bullet3/src/BulletCollision/CollisionDispatch/btCollisionDispatcherMt.h"
#include "../../vendor/bullet3/src/BulletDynamics/ConstraintSolver/btSequentialImpulseConstraintSolverMt.h"
#include "../../vendor/bullet3/src/BulletDynamics/Dynamics/btDiscreteDynamicsWorldMt.h"
#include "../../vendor/bullet3/src/LinearMath/btThreads.h"
#include "../../vendor/bullet3/src/BulletCollision/CollisionDispatch/btGhostObject.h"
#include "../../vendor/bullet3cl/src/BulletDynamics/Character/btKinematicCharacterController.h"
// #include "../../src/extras/DynamicCharacterController.h"
#include <vector>
#include <future>
...
class chai_collisions
{
    ...
    {
        public:
        World(btBroadphaseInterface *broadphase = nullptr, btDefaultCollisionConfiguration *collisionConfiguration = nullptr, btCollisionDispatcherMt *dispatcher = nullptr, btSequentialImpulseConstraintSolverMt *solver = nullptr, btDiscreteDynamicsWorldMt *dynamicsWorld = nullptr)
        {
