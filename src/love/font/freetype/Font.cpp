...
FontMod::FontMod()
	: love::fontmod::FontMod("love.font.freetype")
{
...
Rasterizer *FontMod::newRasterizer(love::filesystemmod::FileData *data)
{
	if (TrueTypeRasterizer::accepts(library, data))
		return newTrueTypeRasterizer(data, 12, fontmod::TrueTypeRasterizer::Settings());
...
Rasterizer *FontMod::newTrueTypeRasterizer(love::Data *data, int size, const fontmod::TrueTypeRasterizer::Settings &settings)
{
