...
FontMod::FontMod(const char *name)
	: Module(M_FONT, name)
{
...
GlyphData *FontMod::newGlyphData(Rasterizer *r, const std::string &text)
{
	uint32 codepoint = 0;
...
GlyphData *FontMod::newGlyphData(Rasterizer *r, uint32 glyph)
{
