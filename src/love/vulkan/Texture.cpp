...
Texture::Texture(Graphics *gfx, const Settings &settings, const Slices *data)
...
Texture::Texture(Graphics *gfx, love::gfx::Texture *base, const ViewSettings &viewsettings)
...
VkClearColorValue Texture::getClearColor(love::gfx::Texture *texture, const ColorD &color)
{
...
void Texture::copyFromBuffer(gfx::Buffer *source, size_t sourceoffset, int sourcewidth, size_t size, int slice, int mipmap, const Rect &rect)
{
	auto commandBuffer = vgfx->getCommandBufferForDataTransfer();
...
void Texture::copyToBuffer(gfx::Buffer *dest, int slice, int mipmap, const Rect &rect, size_t destoffset, int destwidth, size_t size)
{
	auto commandBuffer = vgfx->getCommandBufferForDataTransfer();
