...
class Buffer final
	: public love::gfx::Buffer
	, public Volatile
{
public:
	Buffer(love::gfx::Graphics *gfx, const Settings &settings, const std::vector<DataDeclaration> &format, const void *data, size_t size, size_t arraylength);
	virtual ~Buffer();
