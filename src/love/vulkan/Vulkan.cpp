...
VkPrimitiveTopology Vulkan::getPrimitiveTypeTopology(gfx::PrimitiveType primitiveType)
{
...
VkDescriptorType Vulkan::getDescriptorType(gfx::Shader::UniformType type)
{
	switch (type)
	{
	case gfx::Shader::UniformType::UNIFORM_FLOAT:
	case gfx::Shader::UniformType::UNIFORM_MATRIX:
	case gfx::Shader::UniformType::UNIFORM_INT:
	case gfx::Shader::UniformType::UNIFORM_UINT:
	case gfx::Shader::UniformType::UNIFORM_BOOL:
		return VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER_DYNAMIC;
	case gfx::Shader::UniformType::UNIFORM_SAMPLER:
		return VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER;
	case gfx::Shader::UniformType::UNIFORM_STORAGETEXTURE:
		return VK_DESCRIPTOR_TYPE_STORAGE_IMAGE;
	case gfx::Shader::UniformType::UNIFORM_TEXELBUFFER:
		return VK_DESCRIPTOR_TYPE_STORAGE_TEXEL_BUFFER;
	case gfx::Shader::UniformType::UNIFORM_STORAGEBUFFER:
